      ...
      <div className="checkout-page">
        ...
        <div className="checkout-grid">
          <div className="order-summary">
            {deliveryOptns.length > 0 &&
              cartItems.map((cartItem) => {
                const selectedDeliveryOption = deliveryOptns.find(
                  (deliveryOptn) => {
                          ...
                          return (
                            ...
                            >
                              <input
                                type="radio"
                                checked={
                                  deliveryOptn.id === cartItem.deliveryOptionId
                                }
                              ...
                              <div>
                                <div className="delivery-option-date">
                                  {dayjs(
                                    deliveryOptn.estimatedDeliveryTimeMs,
                                  ).format("dddd, MMMM D")}
                                </div>
          ...
          <div className="payment-summary">
            ...
            {paymentSummary && ( // Checking if payement Summary Exists or not chaina bane it will not run
              <>
